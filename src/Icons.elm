...
logo : String -> Svg msg
logo classStr =
    svg [ class classStr, viewBox "0 0 180 120", width "360", height "240" ] [ Svg.title [] [ text "Parser Combinator Icon" ], Svg.path [ d "M20 30 L6 60 L20 90", fill "none", stroke "#0F172A", strokeWidth "6", strokeLinecap "round", strokeLinejoin "round" ] [], Svg.path [ d "M160 30 L174 60 L160 90", fill "none", stroke "#0F172A", strokeWidth "6", strokeLinecap "round", strokeLinejoin "round" ] [], g [ stroke "#0B7A75", strokeWidth "4", strokeLinecap "round" ] [ line [ x1 "90", y1 "30", x2 "60", y2 "70" ] [], line [ x1 "90", y1 "30", x2 "120", y2 "70" ] [] ], circle [ cx "90", cy "30", r "14", fill "#06B6D4", stroke "#065F60", strokeWidth "2" ] [], text_ [ x "90", y "34", fontFamily "Inter, sans-serif", fontSize "12", fill "#012026", textAnchor "middle", dominantBaseline "middle" ] [ text "P" ], circle [ cx "60", cy "70", r "12", fill "#34D399", stroke "#116A52", strokeWidth "2" ] [], text_ [ x "60", y "74", fontFamily "Inter, sans-serif", fontSize "11", fill "#02271F", textAnchor "middle", dominantBaseline "middle" ] [ text "a" ], circle [ cx "120", cy "70", r "12", fill "#FBBF24", stroke "#B45309", strokeWidth "2" ] [], text_ [ x "120", y "74", fontFamily "Inter, sans-serif", fontSize "11", fill "#10220B", textAnchor "middle", dominantBaseline "middle" ] [ text "b" ] ]
